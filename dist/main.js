...
},{}],"7Kn2D":[function(require,module,exports,__globalThis) {
/*!
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MatrixController", ()=>MatrixController);
parcelHelpers.export(exports, "MatrixElement", ()=>MatrixElement);
var _chartJs = require("chart.js");
var _helpers = require("chart.js/helpers");
var version = "2.0.1";
class MatrixController extends (0, _chartJs.DatasetController) {
    static id = 'matrix';
    ...
    draw() {
        ...
        let i, ilen;
        for(i = 0, ilen = data.length; i < ilen; ++i)data[i].draw(me._ctx);
    }
}
function resolveX(anchorX, x, width) {
    if (anchorX === 'left' || anchorX === 'start') return x;
    if (anchorX === 'right' || anchorX === 'end') return x - width;
    return x - width / 2;
}
function resolveY(anchorY, y, height) {
    if (anchorY === 'top' || anchorY === 'start') return y;
    if (anchorY === 'bottom' || anchorY === 'end') return y - height;
    return y - height / 2;
}
/**
...
class MatrixElement extends (0, _chartJs.Element) {
    static id = 'matrix';
    static defaults = {
    ...
    draw(ctx) {
        ...
        const radius = (0, _helpers.toTRBLCorners)(options.borderRadius);
        ctx.save();
...
},{"chart.js":"ipU8D","chart.js/helpers":"dxsY3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ipU8D":[function(require,module,exports,__globalThis) {
/*!
 * Chart.js v4.4.8
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dxsY3":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./chunks/helpers.segment.js":"7oQuk","@kurkle/color":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gMG4g":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
